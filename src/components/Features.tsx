          ...
          <div className="flex flex-col items-start gap-2">
            <div className="flex items-center gap-2">
              <img
                ...
                alt=""
              />
              <h2 className="text-xl sm:text-2xl font-medium text-[#1d1d1d]">
                Productivity
              </h2>
            </div>
            <p className="text-sm sm:text-md font-light text-[#4b4b4b] max-w-sm text-start">
              Boost your efficiency with tools designed to streamline your
              workflow and enhance focus.
            </p>
          </div>
          <div className="flex flex-col items-start gap-2">
            <div className="flex items-center gap-2">
            ...
            <p className="text-sm sm:text-md font-light text-[#4b4b4b] max-w-sm text-start">
              Unleash your creative potential with innovative features that
              inspire and empower your ideas.
            </p>
          </div>
          <div className="flex flex-col items-start gap-2">
            <div className="flex items-center gap-2">
            ...
            <p className="text-sm sm:text-md font-light text-[#4b4b4b] max-w-sm text-start">
              Enhance teamwork with seamless communication and project
              management tools.
            </p>
          </div>
        </motion.div>
