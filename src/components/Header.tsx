  ...
  return (
    <>
      <header className="p-7 sm:px-14 relative py-4 flex items-center gap-6 justify-between sm:justify-center  text-white w-full z-50">
        ...
        <button onClick={()=>setOpen(true)} className='cursor-pointer'><CgMenuRight size={25}/></button>
    ...
    >
      ...
      <AnimatePresence>
       ...
       <AnimatePresence>
         ...
         >
         <div
         className="fixed bg-white flex flex-col items-start justify-between top-0 p-8 bottom-0 w-full h-full z-[999]" >
          <div className="flex items-center w-full justify-between">
            <h1>Gamified</h1>
            <button onClick={()=>setOpen(false)}><CgClose size={25}/></button>
          </div>
          <div
         
          className="flex flex-col items-start gap-6 mt-10 w-full px-4">
          {navbar.map((item: Navbar) => (
            <motion.div layout key={item.name} className="w-full">
              <div className="text-black text-xl flex flex-col items-start gap-2 hover:text-black transition-all duration-200 cursor-pointer select-none">
                {item.link ? (
                  <a href={item.link} onClick={() => chooseExplore(item.name)}>{item.name}</a>
                ) : (
                  <button onClick={() => chooseExplore(item.name)} className="text-left">
                    {item.name}
                  </button>
                )}
              </div>
                      ...
                      <div className="px-4">
                        <div className="flex flex-col items-start gap-4">
                          <div className="flex flex-col items-start gap-2">
                            <div className="flex items-center gap-2">
                              <img src="https://framerusercontent.com/images/8XloMG9slaAAviwFXnArBqT18Y.svg" className="w-6 h-6" alt="" />
                              <h2 className="text-sm font-medium text-[#1d1d1d]">Productivity</h2>
                            </div>
                            <p className="text-xs font-light text-[#4b4b4b] max-w-sm text-start">Boost your efficiency with tools designed to streamline your workflow and enhance focus.</p>
                          </div>
                          ...
                          <div className="flex flex-col items-start gap-2">
                            <div className="flex items-center gap-2">
                              <img src="https://framerusercontent.com/images/fP8VSisvho3qaGtdE1UDgWG1N3g.svg" className="w-6 h-6" alt="" />
                              <h2 className="text-sm font-medium text-[#1d1d1d]">Creativity</h2>
                            </div>
                            <p className="text-xs font-light text-[#4b4b4b] max-w-sm text-start">Unleash your creative potential with innovative features that inspire and empower your ideas.</p>
                          </div>
                          ...
                          <div className="flex flex-col items-start gap-2">
                            <div className="flex items-center gap-2">
                              <img src="https://framerusercontent.com/images/oI6jpPOLQDHv6FbcH28j1VQ8.svg" className="w-6 h-6" alt="" />
                              <h2 className="text-sm font-medium text-[#1d1d1d]">Collaboration</h2>
                            </div>
                            <p className="text-xs font-light text-[#4b4b4b] max-w-sm text-start">Enhance teamwork with seamless communication and project management tools.</p>
                          </div>
                        </div>
