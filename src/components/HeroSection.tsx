    ...
    <section className="relative h-screen w-full overflow-hidden flex flex-col items-start bg-white justify-center md:justify-start">
      ...
      >
        ...
        <div className="flex items-center justify-between w-full mt-6 pb-6 border-b border-white/30">
          ...
          <button
            ...
            className="explore text-white border border-white/50 rounded-full p-1.5 sm:p-2.5 cursor-pointer  text-xs sm:text-sm font-medium"
          >
            Start Exploring
          </button>
        </div>
        ...
        >
          <p className="text-white text-sm sm:text-md font-light w-full sm:w-3/5 md:w-2/6 text-end text-balance">
            Discovery doesn't always begin with knowing. It starts with
            questions.Context that guide understanding forward,that's why we are
            here , to improve
          </p>
        </motion.div>
      </motion.div>
      ...
      <AnimatePresence>
        {info && (
          ...
          >
            <div
              className="fixed bg-black/50 top-0 bottom-0 w-full h-full z-[999]"
            ...
            <div className="fixed bg-white flex flex-col items-start text-black p-3 rounded-2xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[370px] z-[1000]">
              ...
              <p className="text-sm font-light mb-4 text-start ">
              ...
              <form action="" onSubmit={submitName}>
                ...
                type="text"
                className="border border-[#2563eb] p-1.5 rounded-2xl focus:outline-0 mb-4 text-black w-full text-sm"
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <button
                  onClick={() => setInfo(false)}
                  className="bg-white text-black px-4 py-2 rounded-full mb-2"
                >
                  Close
                </button>
              </div>
